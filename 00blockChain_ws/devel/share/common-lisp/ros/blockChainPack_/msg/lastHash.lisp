...
(cl:defclass <lastHash> (roslisp-msg-protocol:ros-message)
  ((nodeName
    ...
    :initform "")
   (blockchainNumber
    :reader blockchainNumber
    :initarg :blockchainNumber
    :type cl:integer
    :initform 0)
   (hash
    :reader hash
...
(cl:ensure-generic-function 'blockchainNumber-val :lambda-list '(m))
(cl:defmethod blockchainNumber-val ((m <lastHash>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader blockChainPack_-msg:blockchainNumber-val is deprecated.  Use blockChainPack_-msg:blockchainNumber instead.")
  (blockchainNumber m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <lastHash>) ostream)
  ...
  (cl:let* ((signed (cl:slot-value msg 'blockchainNumber)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 18446744073709551616) signed)))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <lastHash>) istream)
  "Deserializes a message object of type '<lastHash>"
    ...
    (cl:let ((unsigned 0))
      ...
      (cl:setf (cl:slot-value msg 'blockchainNumber) (cl:if (cl:< unsigned 9223372036854775808) unsigned (cl:- unsigned 18446744073709551616))))
    (cl:let ((__ros_str_len 0))
      (cl:setf (cl:ldb (cl:byte 8 0) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) __ros_str_len) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<lastHash>)))
  ...
  "b2ba33a8c1f1e56810104ccd6ef48d61")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'lastHash)))
  "Returns md5sum for a message object of type 'lastHash"
  "b2ba33a8c1f1e56810104ccd6ef48d61")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<lastHash>)))
  ...
  (cl:format cl:nil "string nodeName~%int64 blockchainNumber~%string hash~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'lastHash)))
  "Returns full string definition for message of type 'lastHash"
  (cl:format cl:nil "string nodeName~%int64 blockchainNumber~%string hash~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <lastHash>))
  ...
  (cl:list 'lastHash
    ...
    (cl:cons ':blockchainNumber (blockchainNumber msg))
