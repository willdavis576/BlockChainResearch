...
if(NOT "/home/pi/blockChainGit/00blockChain_ws/devel/include " STREQUAL " ")
  set(blockChainPack__INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/blockChainGit/00blockChain_ws/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'blockChainPack_' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/blockChainGit/00blockChain_ws/src/blockChainPack_/${idir}'.  ${_report}")
    endif()
