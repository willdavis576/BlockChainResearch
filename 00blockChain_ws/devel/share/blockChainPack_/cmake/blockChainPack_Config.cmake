...
if(NOT "/home/ros/blockChainGit/00blockChain_ws/devel/include " STREQUAL " ")
  set(blockChainPack__INCLUDE_DIRS "")
  set(_include_dirs "/home/ros/blockChainGit/00blockChain_ws/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'blockChainPack_' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ros/blockChainGit/00blockChain_ws/src/blockChainPack_/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ros/blockChainGit/00blockChain_ws/devel/lib;/home/ros/blockChainGit/00blockChain_ws/devel/lib;/opt/ros/kinetic/lib)
