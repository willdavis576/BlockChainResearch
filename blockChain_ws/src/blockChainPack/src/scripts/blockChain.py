...
repeat = 0
newProduct = ''
pub = rospy.Publisher('publishingBlockStream', String, queue_size=10)
...
def mainProg():
    ...
    while(True):
	    ...
	    #publish data to ROS
	    testString = "Hello listener, this is a test"
	    rospy.loginfo(testString) #show on terminal
            pub.publish(testString) #publish to publisher
