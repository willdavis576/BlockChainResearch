...
def callback(data):
    ...
    if runYet[productNumber] == '':
        f = open("/home/pi/blockChainGit/00blockChain_ws/blockChain" + str(productNumber) + ".txt", "w")
        f.close()
        runYet[productNumber] = "1"
    if runYet[productNumber] == "1":
        f = open("/home/pi/blockChainGit/00blockChain_ws/blockChain" + str(productNumber) + ".txt", "a")
